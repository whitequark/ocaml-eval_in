...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6f5115b473827c1c745927ac82b8e6b6) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "An IRC bot that submits requests to http://eval.in";
          description = None;
          categories = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "eval_in.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\234\131-\212n\028L\127@.\176\003\175\176U\197";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
